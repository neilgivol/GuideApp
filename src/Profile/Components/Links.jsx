            ...
            <div>
                ...
                <Row>
                    ...
                    <Col md="12" className="form-group">
                        <ul>
                            {this.state.fulllink.map((item,index )=> <li key={index} onClick={() => { this.delUrl(item) }} value={item} className="urlAndType">{item} <i value={item} className="fas fa-backspace" ></i></li>)}
                        </ul>
                    </Col>
